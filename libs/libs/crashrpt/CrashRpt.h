...
//  Module: CrashRpt.h
//
//    Desc: Defines the interface for the CrypticCrashRpt.DLL.
//
...
typedef void (CREXPORT *pfnCrashRptGenerateErrorReport2)(IN LPVOID lpState, IN PEXCEPTION_POINTERS pExInfo, IN const char* szVersion, IN const char* szMessage);
...
typedef void (CREXPORT *pfnCrashRptGenerateErrorReport3)(IN LPVOID lpState, IN PEXCEPTION_POINTERS pExInfo, IN const char* szVersion, IN const char* szMessage, DWORD dwThreadID);
