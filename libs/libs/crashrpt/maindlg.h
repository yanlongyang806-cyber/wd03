...
public:
	...
	LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
		...
		//
		SetWindowText(_T("Crashed Application"));
		...
		icon.Attach(GetDlgItem(IDI_APPICON));
		{
			...
			if(!hIcon)
				hIcon = ::LoadIcon((HINSTANCE)GetModuleHandle("CrypticCrashRpt.DLL"), MAKEINTRESOURCE(IDI_CRYPTIC));
		}
		icon.SetIcon(hIcon);
		icon.Detach();
...
This application has encountered a problem and needs to close.  The crash appears to have \
...
known issues with this application.  Updating your video card drivers will likely \
increase the stability of this application. \n\
\n\
