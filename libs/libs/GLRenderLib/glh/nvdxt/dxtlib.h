...
JE: 11-2-2004: Made changes to #include and #pragmas to compile in our project, and
		converted to C compatible code

*****************************************************************************************/
#pragma once

#include <nvdxt/nvdxt_options.h>
...
#ifndef ISPOWER2
_inline bool IsPower2(unsigned int x)
{              
    if ( x < 1 )
        return false;
...
HRESULT nvDXTcompressVolume(unsigned char * raw_data, // pointer to data (24 or 32 bit)
                unsigned long w, // width in texels
                unsigned long h, // height in texels
