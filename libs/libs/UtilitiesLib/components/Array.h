...
#define arrayPushBackUnique(array, element) arrayPushBackUnique_dbg(array, element MEM_DBG_PARMS_INIT)
void arrayPushBackArray_dbg(Array* dst, Array* src MEM_DBG_PARMS);
#define arrayPushBackArray(dst, src) arrayPushBackArray_dbg(dst, src MEM_DBG_PARMS_INIT)
