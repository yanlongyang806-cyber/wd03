...
int triCube(Vec3 cube_pos,Vec3 cube_size,Vec3 v1,Vec3 v2,Vec3 v3)
{
	...
	scaleVec3(cube_size, 0.5f, sub_pos);
	addVec3(cube_pos,sub_pos,sub_pos);

	inv_size[0] = 1.f / cube_size[0];
	inv_size[1] = 1.f / cube_size[1];
	inv_size[2] = 1.f / cube_size[2];

	subVec3(v1,sub_pos,verts[0]);
	subVec3(v2,sub_pos,verts[1]);
	subVec3(v3,sub_pos,verts[2]);

	scaleVec3(verts[0],inv_size[0],verts[0]);
	scaleVec3(verts[1],inv_size[1],verts[1]);
	scaleVec3(verts[2],inv_size[2],verts[2]);
