...
*	
*/
__forceinline void debugSetRegister(CONTEXT* context, BreakPointID breakpoint, uintptr_t data)
{
	// cast mania
...
void debugSetDataBreakPointEx(BreakPointID breakpoint, void* dataAddress, BreakCondition condition)
{
	...
	DB_SET_BITS(control, DB_GET_BREAK_CONDITION_BIT(breakpoint),	condition);
