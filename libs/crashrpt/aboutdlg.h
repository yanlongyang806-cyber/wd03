...
//      HGLOBAL hgres = NULL;
//
//      hrsrc = FindResource(GetModuleHandle(_T("CrypticCrashRpt.DLL")), MAKEINTRESOURCE(IDR_LICENSE), "TEXT");
//
//      hgres = LoadResource(GetModuleHandle(_T("CrypticCrashRpt.DLL")), hrsrc);
//
