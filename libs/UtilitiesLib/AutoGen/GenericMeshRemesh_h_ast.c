...
ParseTable parse_WorldClusterStats[] =
{
	...
	{ "{",						TOK_START, 0 },
	{ "clusteringTotals",		TOK_EMBEDDEDSTRUCT(WorldClusterStats, clusteringTotals, parse_TaskProfile)},
	{ "netSend",				TOK_EMBEDDEDSTRUCT(WorldClusterStats, netSend, parse_TaskProfile)},
	{ "netRecv",				TOK_EMBEDDEDSTRUCT(WorldClusterStats, netRecv, parse_TaskProfile)},
	{ "wtexDecompress",			TOK_EMBEDDEDSTRUCT(WorldClusterStats, wtexDecompress, parse_TaskProfile)},
	{ "modelExport",			TOK_EMBEDDEDSTRUCT(WorldClusterStats, modelExport, parse_TaskProfile)},
	{ "pngExport",				TOK_EMBEDDEDSTRUCT(WorldClusterStats, pngExport, parse_TaskProfile)},
	{ "convertGeo",				TOK_EMBEDDEDSTRUCT(WorldClusterStats, convertGeo, parse_TaskProfile)},
	{ "remeshGeo",				TOK_EMBEDDEDSTRUCT(WorldClusterStats, remeshGeo, parse_TaskProfile)},
	{ "CastTextures",			TOK_STRUCT(WorldClusterStats, eaCastTextures, parse_TaskProfile) },
	{ "wtexCompress",			TOK_EMBEDDEDSTRUCT(WorldClusterStats, wtexCompress, parse_TaskProfile)},
	{ "cacheGeo",				TOK_EMBEDDEDSTRUCT(WorldClusterStats, cacheGeo, parse_TaskProfile)},
	{ "cacheTex",				TOK_EMBEDDEDSTRUCT(WorldClusterStats, cacheTex, parse_TaskProfile)},
	{ "msetBinGeneration",		TOK_EMBEDDEDSTRUCT(WorldClusterStats, msetBinGeneration, parse_TaskProfile)},
	{ "wtexBinGeneration",		TOK_EMBEDDEDSTRUCT(WorldClusterStats, wtexBinGeneration, parse_TaskProfile)},
	{ "clientClusterBinSize",	TOK_EMBEDDEDSTRUCT(WorldClusterStats, clientClusterBinSize, parse_TaskProfile)},
