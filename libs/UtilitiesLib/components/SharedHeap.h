...
bool sharedHeapLazySyncHandlesOnly(void);

bool sharedHeapLazySync(void);

// Returns how many pages we have locally mapped
U32 getSharedHeapMemoryManagerPageAllocs(void);
...
void printSharedHeapInfo(void);

// Simply stores a string in the shared heap, and then retreives and prints it
void testSharedHeap(void);

void sharedHeapEmergencyMutexRelease(void);
