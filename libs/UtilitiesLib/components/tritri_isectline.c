...
#define SORT2(a,b,smallest)       \
 ...
 void isect2(const float VTX0[3],const float VTX1[3],const float VTX2[3],float VV0,float VV1,float VV2,
...
static int compute_intervals_isectline(const float VERT0[3],const float VERT1[3],const float VERT2[3],
...
int tri_tri_intersect_with_isectline(	const float V0[3],
										const float V1[3],
										const float V2[3],
										const float U0[3],
										const float U1[3],
