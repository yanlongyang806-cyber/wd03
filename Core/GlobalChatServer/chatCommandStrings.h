...
#define CHATCOMMAND_CHANNEL_UNINVITE "ChannelUninvite"
#define CHATCOMMAND_CHANNEL_DECLINEINVITE "ChannelDeclineInvite"

#define CHATCOMMAND_CHANNEL_BAN "ChannelBan"
#define CHATCOMMAND_CHANNEL_UNBAN "ChannelUnban"
